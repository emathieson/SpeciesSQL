...
/****** Object:  StoredProcedure [etl].[Load_Park_Everglades]    Script Date: 9/7/2023 6:18:19 PM ******/
SET ANSI_NULLS ON
GO
...
CREATE OR ALTER PROCEDURE [etl].[Load_Park_Everglades]


AS
/*
PURPOSE:
Truncates and then loads information into the Park.Everglades table
...
CREATE TABLE #herp_base
	...
	INSERT INTO #herp_base
		...
		WHERE hps.Everglades IS NOT NULL
...
CREATE TABLE #Fish_base
	...
	INSERT INTO #Fish_base
		...
		WHERE fsh.Everglades IS NOT NULL
...
CREATE TABLE #Mammals_base
	...
	INSERT INTO #Mammals_base
		...
		WHERE mam.Everglades IS NOT NULL
...
CREATE TABLE #Inverts_base
	...
	INSERT INTO #Inverts_base
		...
		WHERE inv.Everglades IS NOT NULL
...
CREATE TABLE #Birds_base
	...
	INSERT INTO #Birds_base
		...
		WHERE brd.Everglades IS NOT NULL
...
TRUNCATE TABLE Park.Everglades
INSERT INTO Park.Everglades
SELECT * FROM #temp_union

--Display table after insert
SELECT * FROM Park.Everglades
