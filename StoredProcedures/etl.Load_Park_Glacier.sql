...
/****** Object:  StoredProcedure [etl].[Load_Park_Glacier]    Script Date: 9/7/2023 6:19:26 PM ******/
SET ANSI_NULLS ON
GO
...
CREATE OR ALTER PROCEDURE [etl].[Load_Park_Glacier]


AS
/*
PURPOSE:
Truncates and then loads information into the Park.Glacier table
...
TRUNCATE TABLE Park.Glacier
INSERT INTO Park.Glacier
SELECT * FROM #temp_union

--Display table after insert
SELECT * FROM Park.Glacier
