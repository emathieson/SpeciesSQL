...
/****** Object:  StoredProcedure [etl].[Load_Park_Redwoods]    Script Date: 9/7/2023 6:27:45 PM ******/
SET ANSI_NULLS ON
GO
...
CREATE OR ALTER PROCEDURE [etl].[Load_Park_Redwoods]


AS
/*
PURPOSE:
Truncates and then loads information into the Park.Redwoods table
...
CREATE TABLE #herp_base
	...
	INSERT INTO #herp_base
		...
		WHERE hps.Redwoods IS NOT NULL
...
CREATE TABLE #Fish_base
	...
	INSERT INTO #Fish_base
		...
		WHERE fsh.Redwoods IS NOT NULL
...
CREATE TABLE #Mammals_base
	...
	INSERT INTO #Mammals_base
		...
		WHERE mam.Redwoods IS NOT NULL
...
CREATE TABLE #Inverts_base
	...
	INSERT INTO #Inverts_base
		...
		WHERE inv.Redwoods IS NOT NULL
...
CREATE TABLE #Birds_base
	...
	INSERT INTO #Birds_base
		...
		WHERE brd.Redwoods IS NOT NULL
...
TRUNCATE TABLE Park.Redwoods
INSERT INTO Park.Redwoods
SELECT * FROM #temp_union

--Display table after insert
SELECT * FROM Park.Redwoods
