...
/****** Object:  StoredProcedure [etl].[Load_Park_Saguaro]    Script Date: 9/7/2023 6:28:44 PM ******/
SET ANSI_NULLS ON
GO
...
CREATE OR ALTER PROCEDURE [etl].[Load_Park_Saguaro]


AS
/*
PURPOSE:
Truncates and then loads information into the Park.Saguaro table
...
TRUNCATE TABLE Park.Saguaro
INSERT INTO Park.Saguaro
SELECT * FROM #temp_union

--Display table after insert
SELECT * FROM Park.Saguaro
