...
/****** Object:  StoredProcedure [etl].[Load_Park_Zion]    Script Date: 9/7/2023 6:30:16 PM ******/
SET ANSI_NULLS ON
GO
...
CREATE OR ALTER PROCEDURE [etl].[Load_Park_Zion]


AS
/*
PURPOSE:
Truncates and then loads information into the Park.Zion table
...
TRUNCATE TABLE Park.Zion
INSERT INTO Park.Zion
SELECT * FROM #temp_union

--Display table after insert
SELECT * FROM Park.Zion
