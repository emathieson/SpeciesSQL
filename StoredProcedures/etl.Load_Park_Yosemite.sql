...
/****** Object:  StoredProcedure [etl].[Load_Park_Yosemite]    Script Date: 9/7/2023 6:29:48 PM ******/
SET ANSI_NULLS ON
GO
...
CREATE OR ALTER PROCEDURE [etl].[Load_Park_Yosemite]


AS
/*
PURPOSE:
Truncates and then loads information into the Park.Yosemite table
...
CREATE TABLE #herp_base
	...
	INSERT INTO #herp_base
		...
		WHERE hps.Yosemite IS NOT NULL
...
CREATE TABLE #Fish_base
	...
	INSERT INTO #Fish_base
		...
		WHERE fsh.Yosemite IS NOT NULL
...
CREATE TABLE #Mammals_base
	...
	INSERT INTO #Mammals_base
		...
		WHERE mam.Yosemite IS NOT NULL
...
CREATE TABLE #Inverts_base
	...
	INSERT INTO #Inverts_base
		...
		WHERE inv.Yosemite IS NOT NULL
...
CREATE TABLE #Birds_base
	...
	INSERT INTO #Birds_base
		...
		WHERE brd.Yosemite IS NOT NULL
...
TRUNCATE TABLE Park.Yosemite
INSERT INTO Park.Yosemite
SELECT * FROM #temp_union

--Display table after insert
SELECT * FROM Park.Yosemite
